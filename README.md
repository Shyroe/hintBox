...
![alt](https://img.shields.io/github/contributors/Shyroe/hintBox.svg?style=flat&color=orange)
![alt](https://img.shields.io/github/forks/Shyroe/hintBox.svg?color=orange)
...
- NextJs with SWR(create api to frontend)
- Google Spreadsheet integration
- Tailwind with css modules to styling
...
Pay attention: Generate your credentials.json file in Google Cloud Console platform before getting started application
...
**Answer**: NextJs; Tailwindcss; google-spreadsheet; SWR
